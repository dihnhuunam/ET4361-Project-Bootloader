...
- Firmware size không vượt quá dung lượng slot.
...
4. Bootloader kiểm tra firmware size không vượt quá 104 KB.
...
- Application kiểm tra firmware size không vượt quá 104 KB.
...
Metadata nên được tổ chức thành nhiều bản dự phòng hoặc nhiều bản ghi tuần tự. Mỗi lần cập nhật metadata, hệ thống ghi một bản mới với sequence number tăng lên. Khi khởi động, bootloader đọc các bản metadata, kiểm tra magic value và CRC metadata, sau đó chọn bản hợp lệ mới nhất.
...
MCU sử dụng STM32 có tổng dung lượng Flash là 256 KB. Flash được tổ chức thành 128 page, đánh số từ page 0 đến page 127. Mỗi page có kích thước 2 KB.

Flash base address là 0x08000000. Toàn bộ vùng Flash kết thúc tại 0x0803FFFF.
...
| Application 1     |  24 - 75 |      0x0800C000 |       0x08025FFF |     104 KB | Application slot 1                                                   |
| Application 2     | 76 - 127 |      0x08026000 |       0x0803FFFF |     104 KB | Application slot 2                                                   |
...
| Application 1     |     104 KB |
| Application 2     |     104 KB |
| Tổng cộng         |     256 KB |
...
Bootloader chiếm 16 page đầu tiên, tương đương 32 KB. Dung lượng này được dùng cho các chức năng:
...
Application 1 nằm từ page 24 đến page 75, tổng dung lượng 104 KB. Địa chỉ bắt đầu của Application 1 là 0x0800C000.
...
Application 2 nằm từ page 76 đến page 127, tổng dung lượng 104 KB. Địa chỉ bắt đầu của Application 2 là 0x08026000.
...
5. Bootloader kiểm tra kích thước firmware không vượt quá 104 KB.
...
6. Application kiểm tra kích thước firmware không vượt quá 104 KB.
...
Thiết kế này ưu tiên tính đơn giản, dễ demo và dễ quan sát trên STM32 có Flash 256 KB.
...
- Flash page size là 2 KB nên toàn bộ layout 256 KB được align theo page.
...
Thiết kế này phù hợp cho demo bootloader với các chức năng CRC, rollback, anti-brick và OTA qua UART trên STM32 256 KB Flash.
